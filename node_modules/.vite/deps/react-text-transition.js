import {
  require_react_dom
} from "./chunk-IQSYQBJM.js";
import {
  __commonJS,
  __publicField,
  __toESM,
  require_react
} from "./chunk-OYPCHBSG.js";
...
function Lr(e, t) {
  ...
  return o ? Boolean(t && o.inputs && it(t, o.inputs)) || (o = { inputs: t, result: e() }) : o = r2, (0, import_react5.useEffect)(() => {
...
function gt(t, e, n2) {
  ...
  for (let a in tt2)
    t[a] == null && (t[a] = tt2[a]);
  let { mass: r2, frequency: o, damping: s } = t;
  return l2.und(o) || (o < 0.01 && (o = 0.01), s < 0 && (s = 0), t.tension = Math.pow(2 * Math.PI / o, 2) * r2, t.friction = 4 * Math.PI * s * r2 / o), t;
}
function ht2(t, e) {
  if (!l2.und(e.decay))
    t.duration = void 0;
...
function Me(t, { key: e, props: n2, defaultProps: r2, state: o, actions: s }) {
  return new Promise((a, i2) => {
    ...
    function b4() {
      ...
      try {
        s.start({ ...n2, callId: t, cancel: f3 }, a);
      } catch (c5) {
        i2(c5);
      }
    }
...
function De2(t, e, n2, r2) {
  let { callId: o, parentId: s, onRest: a } = e, { asyncTo: i2, promise: u4 } = n2;
  return !s && t === i2 && !e.reset ? u4 : n2.promise = (async () => {
    ...
    try {
      ...
      o == n2.asyncId && (n2.asyncId = s, n2.asyncTo = s ? i2 : void 0, n2.promise = s ? u4 : void 0);
    }
    return l2.fun(a) && n.batchedUpdates(() => {
      a(P2, r2, r2.item);
    }), P2;
  })();
}
...
var ue2 = class extends X2 {
  ...
  advance(e) {
    let n2 = true, r2 = false, o = this.animation, { config: s, toValues: a } = o, i2 = F(o.to);
    !i2 && Pt(o.to) && (a = ht(ve(o.to))), o.values.forEach((f3, d4) => {
      if (f3.done)
        return;
      let m3 = f3.constructor == d3 ? 1 : i2 ? i2[d4].lastPosition : a[d4], b4 = o.immediate, c5 = m3;
      if (!b4) {
        if (c5 = f3.lastPosition, s.tension <= 0) {
          f3.done = true;
          return;
        }
        let P2 = f3.elapsedTime += e, l4 = o.fromValues[d4], h5 = f3.v0 != null ? f3.v0 : f3.v0 = l2.arr(s.velocity) ? s.velocity[d4] : s.velocity, g3, x4 = s.precision || (l4 == m3 ? 5e-3 : Math.min(1, Math.abs(m3 - l4) * 1e-3));
        if (l2.und(s.duration))
          if (s.decay) {
            let S2 = s.decay === true ? 0.998 : s.decay, A2 = Math.exp(-(1 - S2) * P2);
            c5 = l4 + h5 / (1 - S2) * (1 - A2), b4 = Math.abs(f3.lastPosition - c5) <= x4, g3 = h5 * A2;
          } else {
            g3 = f3.lastVelocity == null ? h5 : f3.lastVelocity;
            let S2 = s.restVelocity || x4 / 10, A2 = s.clamp ? 0 : s.bounce, V3 = !l2.und(A2), _3 = l4 == m3 ? f3.v0 > 0 : l4 < m3, v4, w2 = false, C3 = 1, $2 = Math.ceil(e / C3);
            for (let L3 = 0; L3 < $2 && (v4 = Math.abs(g3) > S2, !(!v4 && (b4 = Math.abs(m3 - c5) <= x4, b4))); ++L3) {
              V3 && (w2 = c5 == m3 || c5 > m3 == _3, w2 && (g3 = -g3 * A2, c5 = m3));
              let N3 = -s.tension * 1e-6 * (c5 - m3), y5 = -s.friction * 1e-3 * g3, T2 = (N3 + y5) / s.mass;
              g3 = g3 + T2 * C3, c5 = c5 + g3 * C3;
            }
          }
        else {
          let S2 = 1;
          s.duration > 0 && (this._memoizedDuration !== s.duration && (this._memoizedDuration = s.duration, f3.durationProgress > 0 && (f3.elapsedTime = s.duration * f3.durationProgress, P2 = f3.elapsedTime += e)), S2 = (s.progress || 0) + P2 / this._memoizedDuration, S2 = S2 > 1 ? 1 : S2 < 0 ? 0 : S2, f3.durationProgress = S2), c5 = l4 + s.easing(S2) * (m3 - l4), g3 = (c5 - f3.lastPosition) / e, b4 = S2 == 1;
        }
        f3.lastVelocity = g3, Number.isNaN(c5) && (console.warn("Got NaN while animating:", this), b4 = true);
      }
      i2 && !i2[d4].done && (b4 = false), b4 ? f3.done = true : n2 = false, f3.setValue(c5, s.round) && (r2 = true);
    });
    let u4 = k2(this), p3 = u4.getValue();
    if (n2) {
      let f3 = ve(o.to);
      (p3 !== f3 || r2) && !s.decay ? (u4.setValue(f3), this._onChange(f3)) : r2 && s.decay && this._onChange(p3), this._stop();
    } else
  ...
  _update({ ...e }, n2) {
    ...
    e.default && Object.assign(o, ne3(e, (i2, u4) => /^on/.test(u4) ? et2(i2, r2) : i2)), _t(this, e, "onProps"), Ie(this, "onProps", e, this);
    let s = this._prepareNode(e);
    if (Object.isFrozen(this))
      throw Error("Cannot animate a `SpringValue` object that is frozen. Did you forget to pass your component to `animated(...)` before animating its props?");
    let a = this._state;
    return Me(++this._lastCallId, { key: r2, props: e, defaultProps: o, state: a, actions: { pause: () => {
      ye2(this) || (it2(this, true), yt(a.pauseQueue), Ie(this, "onPause", E2(this, Ce2(this, this.animation.to)), this));
    }, resume: () => {
      ye2(this) && (it2(this, false), Q4(this) && this._resume(), yt(a.resumeQueue), Ie(this, "onResume", E2(this, Ce2(this, this.animation.to)), this));
    }, start: this._merge.bind(this, s) } }).then((i2) => {
      if (e.loop && i2.finished && !(n2 && i2.noop)) {
        let u4 = at2(e);
        if (u4)
  ...
  _merge(e, n2, r2) {
    ...
    if (o || s)
      if (n2.callId > this._lastToId)
        ...
        return r2(q(this));
    let { key: a, defaultProps: i2, animation: u4 } = this, { to: p3, from: f3 } = u4, { to: d4 = p3, from: m3 = f3 } = e;
    ...
    (o || s) && (l4.velocity = 0), n2.config && !P2 && gt(l4, I2(n2.config, a), n2.config !== i2.config ? I2(i2.config, a) : void 0);
    let x4 = k2(this);
    if (!x4 || l2.und(d4))
      return r2(E2(this, true));
    let S2 = l2.und(n2.reset) ? s && !n2.default : !l2.und(m3) && te2(n2.reset, a), A2 = S2 ? m3 : this.get(), V3 = me2(d4), _3 = l2.num(V3) || l2.arr(V3) || or(V3), v4 = !P2 && (!_3 || te2(i2.immediate || n2.immediate, a));
    if (c5) {
      let L3 = Le2(d4);
    ...
    if ($2 && Q4(this) && (u4.changed && !S2 ? C3 = true : C3 || this._stop(p3)), !P2 && ((C3 || Pt(p3)) && (u4.values = x4.getPayload(), u4.toValues = Pt(d4) ? null : w2 == d3 ? [1] : ht(V3)), u4.immediate != v4 && (u4.immediate = v4, !v4 && !S2 && this._set(p3)), C3)) {
      ...
      yt(this._pendingCalls, N3), this._pendingCalls.add(r2), u4.changed && n.batchedUpdates(() => {
        var _a2;
        u4.changed = !S2, L3 == null ? void 0 : L3(N3, this), S2 ? I2(i2.onRest, N3) : (_a2 = u4.onStart) == null ? void 0 : _a2.call(u4, N3, this);
      });
    }
...
function at2(t, e = t.loop, n2 = t.to) {
  let r2 = I2(e);
  if (r2) {
    let o = r2 !== true && de2(r2), s = (o || t).reverse, a = !o || o.reset;
    return Pe2({ ...t, loop: e, default: false, pause: void 0, to: !s || Ee2(n2) ? n2 : void 0, from: a ? t.from : void 0, reset: a, ...o });
  }
}
function Pe2(t) {
...
var le2 = class {
  ...
  _onFrame() {
    ...
    let a = !o && this._started, i2 = s || a && r2.size ? this.get() : null;
    s && n2.size && Pe(n2, ([u4, p3]) => {
      p3.value = i2, u4(p3, this, this._item);
    }), a && (this._started = false, Pe(r2, ([u4, p3]) => {
      p3.value = i2, u4(p3, this, this._item);
    }));
  }
  eventObserved(e) {
...
async function wt(t, e, n2) {
  let { keys: r2, to: o, from: s, loop: a, onRest: i2, onResolve: u4 } = e, p3 = l2.obj(e.default) && e.default;
  a && (e.loop = false), o === false && (e.to = null), s === false && (e.from = null);
  ...
  (f3 || b4 && d4.asyncId) && m3.push(Me(++t._lastAsyncId, { props: e, state: d4, actions: { pause: Y, resume: Y, start(P2, l4) {
    b4 ? (oe2(d4, t._lastAsyncId), l4(q(t))) : (P2.onRest = i2, l4(De2(f3, P2, d4, t)));
  } } })), d4.paused && await new Promise((P2) => {
    d4.resumeQueue.add(P2);
  });
  let c5 = be2(t, await Promise.all(m3));
  if (a && c5.finished && !(n2 && c5.noop)) {
    let P2 = at2(e, a, o);
    if (P2)
...
function He2(t, e, n2) {
  let r2 = l2.fun(e) && e;
  r2 && !n2 && (n2 = []);
  let o = (0, import_react10.useMemo)(() => r2 || arguments.length == 3 ? fe2() : void 0, []), s = (0, import_react10.useRef)(0), a = Mr(), i2 = (0, import_react10.useMemo)(() => ({ ctrls: [], queue: [], flush(h5, g3) {
    let x4 = _e2(h5, g3);
    return s.current > 0 && !i2.queue.length && !Object.keys(x4).some((A2) => !h5.springs[A2]) ? ze2(h5, g3) : new Promise((A2) => {
      pt(h5, x4), i2.queue.push(() => {
        A2(ze2(h5, g3));
      }), a();
    });
  } }), []), u4 = (0, import_react10.useRef)([...i2.ctrls]), p3 = [], f3 = Ur(t) || 0;
...
function Gt2(t, e, n2) {
  let r2 = l2.fun(e) && e, { reset: o, sort: s, trail: a = 0, expires: i2 = true, exitBeforeEnter: u4 = false, onDestroyed: p3, ref: f3, config: d4 } = r2 ? r2() : e, m3 = (0, import_react13.useMemo)(() => r2 || arguments.length == 3 ? fe2() : void 0, []), b4 = ht(t), c5 = [], P2 = (0, import_react13.useRef)(null), l4 = o ? null : P2.current;
  Q2(() => {
    P2.current = c5;
  }), $r(() => (Ve(c5, (y5) => {
  ...
  let S2 = -a, A2 = Mr(), V3 = ne3(e), _3 = /* @__PURE__ */ new Map(), v4 = (0, import_react13.useRef)(/* @__PURE__ */ new Map()), w2 = (0, import_react13.useRef)(false);
  Ve(c5, (y5, T2) => {
...
function tr(t, { key: e, keys: n2 = e }, r2) {
  if (n2 === null) {
    ...
    return t.map((s) => {
      let a = r2 && r2.find((i2) => i2.item === s && i2.phase !== "leave" && !o.has(i2));
      return a ? (o.add(a), a.key) : er2++;
    });
  }
...
var TextTransition = function(props) {
  var _a2 = props.direction, direction = _a2 === void 0 ? "up" : _a2, _b2 = props.inline, inline = _b2 === void 0 ? false : _b2, _c2 = props.springConfig, springConfig = _c2 === void 0 ? mt2.default : _c2, _d = props.delay, delay = _d === void 0 ? 0 : _d, className = props.className, style = props.style, children = props.children;
  var initialRun = import_react15.default.useRef(true);
  ...
  var _e3 = import_react15.default.useState(0), width = _e3[0], setWidth = _e3[1];
  var currentRef = import_react15.default.useRef(null);
  var heightRef = import_react15.default.useRef("auto");
  import_react15.default.useEffect(function() {
    ...
    var _a3 = elem.getBoundingClientRect(), width2 = _a3.width, height = _a3.height;
    setWidth(width2);
...
TextTransition.propTypes = {
  direction: import_prop_types.default.oneOf(["up", "down"]),
  inline: import_prop_types.default.bool,
  delay: import_prop_types.default.number,
  className: import_prop_types.default.string,
  style: import_prop_types.default.object,
  springConfig: import_prop_types.default.any
};
